        ...
        <footer className='py-10 border-t border-slate-700/50'>
            <div className='flex flex-col md:flex-row gap-4 justify-center md:justify-between items-center' >
                <ul className='flex justify-center items-center gap-4'>
                    <li><a href="https://www.linkedin.com/in/ohyajk"><i className='bx bxl-github text-5xl hover:text-org'></i></a></li>
                    <li><a href="https://www.github.com/ohyajk"><i className='bx bxl-linkedin text-5xl hover:text-org'></i></a></li>
